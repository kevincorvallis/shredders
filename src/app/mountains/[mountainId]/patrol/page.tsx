      ...
      <div className="min-h-screen bg-slate-950 text-slate-100 p-4 md:p-6">
        <div className="max-w-7xl mx-auto">
          <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-6 text-center">
            ...
            <p className="text-slate-400">{error || 'Unable to load safety data'}</p>
            <button
              onClick={() => fetchData()}
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <main className="max-w-7xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <Card className="bg-gradient-to-br from-slate-900 to-slate-800">
            <CardContent className="p-4 text-center">
              <div className={`text-4xl font-bold ${scoreStyle?.color || 'text-slate-300'}`}>
                {powderScore?.toFixed(1) ?? '--'}
              </div>
              <div className="text-sm text-slate-400 mt-1">Powder Score</div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-slate-900 to-slate-800">
            <CardContent className="p-4 text-center">
              ...
              <div className="text-sm text-slate-400 mt-2">Wind Loading</div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-slate-900 to-slate-800">
            <CardContent className="p-4 text-center">
              ...
              <div className="text-xs text-slate-400">Snow Type</div>
            </CardContent>
          </Card>
        </div>
        ...
        {/* Metrics Grid */}
        <div>
          <h2 className="text-lg font-semibold text-slate-300 mb-4">Quick Metrics</h2>
          <MetricsGrid
        ...
        {/* Footer */}
        <footer className="text-center text-xs text-slate-500 pt-6 border-t border-slate-800">
          <p>

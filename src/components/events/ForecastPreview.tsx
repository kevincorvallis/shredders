  ...
  if (compact) {
    return (
      <div className="flex items-center gap-2 text-sm">
        ...
        {forecast.snowfall > 0 && (
          <span className="text-sky-400">{forecast.snowfall}" snow</span>
        )}
        {isPowderDay && (
    ...
    >
      <div className="flex items-start justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-white font-medium">{forecast.conditions}</p>
      ...
      <div className="mt-3 grid grid-cols-3 gap-3">
        <div>
          <p className="text-xs text-gray-500">Snowfall</p>
          <p className="text-sm font-medium text-white">{forecast.snowfall}"</p>
        </div>
        <div>
          <p className="text-xs text-gray-500">Precip</p>
          <p className="text-sm font-medium text-white">{forecast.precipProbability}%</p>
        </div>
        <div>
...
export function BestPowderDayBanner({ day, onApply }: BestPowderDayBannerProps) {
  ...
  return (
    ...
    >
      ...
      <span className="text-xs font-semibold text-white bg-gradient-to-r from-cyan-500 to-blue-500 px-3 py-1 rounded-full shrink-0">
        Apply
      </span>
    </button>
  );

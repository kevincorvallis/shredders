...
export function WebcamWidget({ mountain, name, url, refreshUrl }: WebcamWidgetProps) {
  ...
  return (
    <div className="bg-gradient-to-br from-slate-500/20 to-slate-600/10 rounded-xl overflow-hidden border border-slate-500/30">
      <div className="flex items-center justify-between px-4 py-2 bg-black/20">
        <div>
          <h3 className="text-white font-semibold text-sm">{mountain}</h3>
          <p className="text-gray-400 text-xs">{name} Webcam</p>
        </div>

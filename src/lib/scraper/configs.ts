...
export const scraperConfigs: Record<string, ScraperConfig> = {
  ...
  brundage: {
    ...
    dataUrl: 'https://www.onthesnow.com/idaho/brundage-mountain-resort/skireport',
    type: 'html',
    enabled: true,
    batch: 4,
    selectors: {
  ...
  anthonylakes: {
    ...
    dataUrl: 'https://www.onthesnow.com/oregon/anthony-lakes-mountain-resort/skireport',
    type: 'html',
    enabled: true,
    batch: 4,
    selectors: {
  ...
  revelstoke: {
    ...
    dataUrl: 'https://www.onthesnow.com/british-columbia/revelstoke-mountain/skireport',
    type: 'html',
    enabled: true,
    batch: 4,
    selectors: {
  ...
  red: {
    ...
    dataUrl: 'https://www.onthesnow.com/british-columbia/red-resort/skireport',
    type: 'html',
    enabled: true,
    batch: 5,
    selectors: {
  ...
  apex: {
    ...
    dataUrl: 'https://www.onthesnow.com/british-columbia/apex-mountain/skireport',
    type: 'html',
    enabled: true,
    batch: 6,
    selectors: {
  ...
  vail: {
    ...
    dataUrl: 'https://www.onthesnow.com/colorado/vail/skireport',
    type: 'html',
    enabled: true,
    batch: 9,
    selectors: {
  ...
  breckenridge: {
    ...
    dataUrl: 'https://www.onthesnow.com/colorado/breckenridge/skireport',
    type: 'html',
    enabled: true,
    batch: 9,
    selectors: {
  ...
  beavercreek: {
    ...
    dataUrl: 'https://www.onthesnow.com/colorado/beaver-creek/skireport',
    type: 'html',
    enabled: true,
    batch: 9,
    selectors: {
  ...
  keystone: {
    ...
    dataUrl: 'https://www.onthesnow.com/colorado/keystone/skireport',
    type: 'html',
    enabled: true,
    batch: 9,
    selectors: {
  ...
  mammoth: {
    ...
    dataUrl: 'https://www.onthesnow.com/california/mammoth-mountain-ski-area/skireport',
    type: 'html',
    enabled: true,
    batch: 11,
    selectors: {
  ...
  jacksonhole: {
    ...
    dataUrl: 'https://www.onthesnow.com/wyoming/jackson-hole/skireport',
    type: 'html',
    enabled: true,
    batch: 11,
    selectors: {

...
# File to add
FILE_PATH="PowderTracker/Views/Components/MountainStatusIndicator.swift"
FILE_NAME="MountainStatusIndicator.swift"
...
# Find the Components group and add the file reference
sed -i '' "/\/\* Components \*\/ = {/,/children = (/{ 
    /children = (/a\\
...
echo "File added to Components group"

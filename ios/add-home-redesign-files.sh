...
# Add new iOS home redesign files to Xcode project

cd "$(dirname "$0")/PowderTracker"

# Files to add
FILES=(
    "PowderTracker/ViewModels/HomeViewModel.swift"
    "PowderTracker/Views/Components/MountainLogoView.swift"
    "PowderTracker/Views/Components/MountainCardRow.swift"
    "PowderTracker/Views/Components/FavoritesEmptyState.swift"
    "PowderTracker/Views/FavoritesManagementView.swift"
)

# Add to project using xcodeproj gem
cat > /tmp/add_home_redesign_files.rb << 'RUBY_SCRIPT'
require 'xcodeproj'
...
# Run the Ruby script
ruby /tmp/add_home_redesign_files.rb "PowderTracker.xcodeproj" "${FILES[@]}"

# Clean up
rm /tmp/add_home_redesign_files.rb
...
echo ""
echo "Please rebuild the project in Xcode to verify"

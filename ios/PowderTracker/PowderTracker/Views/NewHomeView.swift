...
struct NewHomeView: View {
    @StateObject private var viewModel = SingleMountainViewModel()
            ...
            ScrollView {
                VStack(spacing: 20) {
                    ...
                    if viewModel.isLoading && viewModel.conditions == nil {
                        ...
                        // Road Conditions - UNIQUE FEATURE!
                        if let mountainId = viewModel.mountain?.id {
                            RoadConditionsSection(
                                roads: viewModel.mockRoadConditions, // TODO: Wire up real data
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            LazyVGrid(columns: [
                ...
                NavigationLink {
                    ForecastView(mountainId: mountainId)
                } label: {
                    QuickActionCard(
                        icon: "calendar",
                ...
                NavigationLink {
                    HistoryChartView(mountainId: mountainId)
                } label: {
                    QuickActionCard(
